...
def analyse(tokens):
    if ")" in tokens:
        highestmathgrade = 4
        klammeroperatorindex = tokens.index(")")
        operatorindex = getindexstartcalc(klammeroperatorindex, tokens) - 1
